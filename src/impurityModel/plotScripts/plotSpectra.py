...
def plot_spectra_in_file(filename):
    ...
    if "xas" in locals():
        ...
        if "rixs" in locals():
            ...
            plt.plot(wIn, (wLoss[1] - wLoss[0]) * np.sum(rixs[0:], axis=(0, 1, 3)) * scaleFY, "-r", label="FY")
            mask = wLoss < 0.2
...
if __name__ == "__main__":
    ...
    parser.add_argument("--filename", type=str, default="spectra.h5", help="Filename containing spectra.")
