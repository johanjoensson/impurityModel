...
#include <complex.h>
#include <stdbool.h>
extern int run_impmod_ed(char label[], char solver_param[], char dc_param[], int dc_flag, double slater[], double _Complex *U_mat, double _Complex *hyb, double _Complex* h_dft,
