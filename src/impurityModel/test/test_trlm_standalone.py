...
from impurityModel.test.test_irlm import MockBasis, get_test_system
...
def test_run():
    ...
    eigvals, eigvecs = thick_restarted_block_lanczos(
        psi0=psi0, h_op=h_op, basis=basis, num_wanted=4, max_subspace_blocks=6, tol=1e-8, max_restarts=50, verbose=True
    )
