...
from setuptools.build_meta import get_requires_for_build_wheel as _original_get_requires_for_build_wheel
from setuptools.build_meta import get_requires_for_build_sdist as _original_get_requires_for_build_sdist
